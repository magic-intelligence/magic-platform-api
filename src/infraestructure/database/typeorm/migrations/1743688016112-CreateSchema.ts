...
export class CreateSchema1743688016112 implements MigrationInterface {
    name = 'CreateSchema1743688016112'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "branch" ("is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "branch_id" BIGSERIAL NOT NULL, "address_id" bigint NOT NULL, "name" character varying NOT NULL, CONSTRAINT "UQ_d6d14945d4352867ecc62bcf85c" UNIQUE ("name"), CONSTRAINT "REL_430511286839d990b8b5ab25a5" UNIQUE ("address_id"), CONSTRAINT "PK_30ca7f4dce440475a49dba3d48c" PRIMARY KEY ("branch_id"))`);
